<main>
    ...
    <form name="add_patient" action="<?=htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post" class="row justify-content-evenly">

        <!-- ---------------------------------------- PERSONNAL INFORMATIONS ---------------------------------------- -->
        <fieldset class="col-9 col-sm-8 col-md-5 col-xl-3 mt-5 mb-4">
            <legend class="fs-5">Informations personnelles du patient</legend>
        ...
        <div class="d-flex flex-center mb-3">
            <input type="submit" value="Enregistrer" class="btn bg-light offset-4 col-4  mt-3 mb-2">
        </div>
    </form>
    </div>
</main>